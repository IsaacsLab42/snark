...
// configuration step. It creates a namespace called `snark`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", snark::cmake::project_name, snark::cmake::project_version) };
